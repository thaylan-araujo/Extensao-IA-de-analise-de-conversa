...
- [ ] **AUTH-04**: Gestor pode fazer login no painel web; papéis separados (gestor vê tudo, advogado não vê dados dos colegas)
- [ ] **AUTH-05**: Gestor pode convidar e remover advogados da sua organização por e-mail
